...
void ServerHandle::start(int framerate, int framesBufferSize)
{
    std::string request = std::to_string(Server::START) + " " + std::to_string(framerate) + " " + std::to_string(framesBufferSize);
    m_pipe.send(request);
